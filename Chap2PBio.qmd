...
```{r}
#| label: tbl-1
#| tbl-cap: Definitions and starting values for the 10 variables in ODE model A. For variables measured as a concentration, the volume within which this is calculated is given in the ‘region’ column. wtCell and cytVol starting values equate to 2175 cells (assuming 2357528 GC bp in the E. coli genome (strain MG1655, EBI Accession U00096.3) and cell volume of 1.03×10-12 mL (72)).
