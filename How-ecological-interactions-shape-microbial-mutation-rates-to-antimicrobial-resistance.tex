...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{twitter }\OtherTok{\textless{}{-}} \FunctionTok{image\_read}\NormalTok{(}\StringTok{\textquotesingle{}Fig1jpg.jpg\textquotesingle{}}\NormalTok{)}
\NormalTok{twitter }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{background\_image}\NormalTok{(twitter) }\SpecialCharTok{+} \FunctionTok{coord\_fixed}\NormalTok{()}
\NormalTok{twitter}
\end{Highlighting}
\end{Shaded}
...
\subcaption{\label{tbl-one-1}For variables measured as a concentration,
the volume within which this is calculated is given in the `region'
column. wtCell and cytVol starting values equate to 2175 cells (assuming
2357528 GC bp in the E. coli genome (strain MG1655, EBI Accession
U00096.3) and cell volume of 1.03×10-12 mL (72).}
...
\leavevmode\vadjust pre{\hypertarget{ref-Maki1992}{}}%
